...
ModuleFactoryAddress=0x8ca9D41545487359e6508ce38faf80E165B411bE
ArbiterAddress=0x2e1b9B77692D662AF998e98666908BA80Fb8018E # our multisig
OracleAddress=0x2239f2669625f6744f0dd0b5c924a61ed191123b
MulticallAddress=0xa9b742eafef518026a6f4bc8cb2ae3b232ca0cf8
...
# --private-key $DEPLOYER_PRIVATE_KEY --etherscan-api-key $GNOSIS_ETHERSCAN_API_KEY \
# --optimizer-runs 20000 \
    #  contracts/mock/SimpleOracle.sol:SimpleOracle  --verify
...
#  --private-key $GOERLI_PRIVATE_KEY --etherscan-api-key $GNOSIS_ETHERSCAN_API_KEY \
# --optimizer-runs 20000 \
    # contracts/mock/SimpleRevenueContract.sol:SimpleRevenueContract --verify
