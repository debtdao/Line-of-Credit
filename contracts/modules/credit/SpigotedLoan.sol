...
abstract contract SpigotedLoan is CreditLoan, ISpigotedLoan {
  ...
  */
    ...
    returns(bool)
  {
    ...
    uint256 debtAmount = debts[positionId].interestAccrued + debts[positionId].principal;
    ...
    _repay(positionId, tokensBought);
