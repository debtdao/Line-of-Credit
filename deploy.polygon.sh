...
echo "Deploying LineLib to $POLYGON_RPC_URL...."
LineLib=$(forge create --rpc-url $POLYGON_RPC_URL \
...
sed -i '' '/\[profile\.polygon\]/,/^\[/s/^libraries = \[.*\]/libraries = \["'$LineLibEntry'"\]/' foundry.toml


echo "Deploying CreditLib...."
CreditLib=$(forge create --rpc-url $POLYGON_RPC_URL \
    --private-key $DEPLOYER_PRIVATE_KEY --etherscan-api-key $ETHERSCAN_API_KEY \
...
sed -i '' '/\[profile\.polygon\]/,/^\[/s/^libraries = \["'$LineLibEntry'"\]/libraries = \["'$LineLibEntry'","'$CreditLibEntry'"\]/' foundry.toml


echo "Deploying CreditListLib...."
CreditListLib=$(forge create --rpc-url $POLYGON_RPC_URL \
    --private-key $DEPLOYER_PRIVATE_KEY --etherscan-api-key $ETHERSCAN_API_KEY \
...
sed -i '' '/\[profile\.polygon\]/,/^\[/s/^libraries = \["'$LineLibEntry'","'$CreditLibEntry'"\]/libraries = \["'$LineLibEntry'","'$CreditLibEntry'","'$CreditListLibEntry'"\]/' foundry.toml


echo "Deploying SpigotLib...."
SpigotLib=$(forge create --rpc-url $POLYGON_RPC_URL \
    --private-key $DEPLOYER_PRIVATE_KEY --etherscan-api-key $ETHERSCAN_API_KEY \
...
sed -i '' '/\[profile\.polygon\]/,/^\[/s/^libraries = \["'$LineLibEntry'","'$CreditLibEntry'","'$CreditListLibEntry'"\]/libraries = \["'$LineLibEntry'","'$CreditLibEntry'","'$CreditListLibEntry'","'$SpigotLibEntry'"\]/' foundry.toml


echo "Deploying EscrowLib...."
EscrowLib=$(forge create --rpc-url $POLYGON_RPC_URL \
    --private-key $DEPLOYER_PRIVATE_KEY --etherscan-api-key $ETHERSCAN_API_KEY \
...
sed -i '' '/\[profile\.polygon\]/,/^\[/s/^libraries = \["'$LineLibEntry'","'$CreditLibEntry'","'$CreditListLibEntry'","'$SpigotLibEntry'"\]/libraries = \["'$LineLibEntry'","'$CreditLibEntry'","'$CreditListLibEntry'","'$SpigotLibEntry'","'$EscrowLibEntry'"\]/' foundry.toml


echo "Deploying SpigotedLineLib...."
SpigotedLineLib=$(forge create --rpc-url $POLYGON_RPC_URL \
    --private-key $DEPLOYER_PRIVATE_KEY --etherscan-api-key $ETHERSCAN_API_KEY \
...
sed -i '' '/\[profile\.polygon\]/,/^\[/s/^libraries = \["'$LineLibEntry'","'$CreditLibEntry'","'$CreditListLibEntry'","'$SpigotLibEntry'","'$EscrowLibEntry'"\]/libraries = \["'$LineLibEntry'","'$CreditLibEntry'","'$CreditListLibEntry'","'$SpigotLibEntry'","'$EscrowLibEntry'","'$SpigotedLineLibEntry'"\]/' foundry.toml
...
# LineFactoryLib=$(forge create --rpc-url $POLYGON_RPC_URL \
#     --private-key $DEPLOYER_PRIVATE_KEY --etherscan-api-key $ETHERSCAN_API_KEY \
...
# sed -i '' '/\[profile\.polygon\]/,/^\[/s/^libraries = \["'$LineLibEntry'","'$CreditLibEntry'","'$CreditListLibEntry'","'$SpigotLibEntry'","'$EscrowLibEntry'","'$SpigotedLineLibEntry'"\]/libraries = \["'$LineLibEntry'","'$CreditLibEntry'","'$CreditListLibEntry'","'$SpigotLibEntry'","'$EscrowLibEntry'","'$SpigotedLineLibEntry'","'$LineFactoryLibEntry'"\]/' foundry.toml




## DEPLOY Oracle for testing bc no FeedRegistry ###
# DummyToken1Address=0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270 # WMATIC
# DummyToken2Address=0x8f3cf7ad23cd3cadbd9735aff958023239c6a063 # DAI

# echo "Deploying Oracle...."
# Oracle=$(forge create --constructor-args $DummyToken1Address $DummyToken2Address --chain gnosis --rpc-url $POLYGON_RPC_URL --verifier-url https://api.gnosisscan.io/api --private-key $DEPLOYER_PRIVATE_KEY --etherscan-api-key $GNOSIS_ETHERSCAN_API_KEY \
...
# ModuleFactory=$(forge create --rpc-url $POLYGON_RPC_URL \
#     --private-key $DEPLOYER_PRIVATE_KEY --etherscan-api-key $ETHERSCAN_API_KEY \
...
# SwapTargetAddress=0xDef1C0ded9bec7F1a1670819833240f027b25EfF    # 0x exchange (same as mainnet)
...
# forge create --rpc-url $POLYGON_RPC_URL --constructor-args 0x3730954eC1b5c59246C1fA6a20dD6dE6Ef23aEa6 0x589a0b00a0dD78Fc2C94b8eac676dec4C3Dcd562 \
# --private-key $DEPLOYER_PRIVATE_KEY --etherscan-api-key $ETHERSCAN_API_KEY  contracts/mock/SimpleOracle.sol:SimpleOracle  --verify


### DEPLOY REV CONTRACT ###

# forge create --rpc-url $POLYGON_RPC_URL --constructor-args 0xf44B95991CaDD73ed769454A03b3820997f00873 0x589a0b00a0dD78Fc2C94b8eac676dec4C3Dcd562 \
